...
<body>
	...
	<form action="complete.php" method="post">
		...
		<tr>
			<td>Task Name</td>
			<td><input type="text" name="name" value="<?php echo $cl_name?>" readonly/></td>
		</tr>
		<tr>
			<td>Task Description</td>
			<td><input type="text" name="description" value="<?php echo $cl_description?>" readonly/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="created_at" value="<?php echo $cl_completed_at?>" readonly/></td>
		</tr>
		<tr>
			<td colspan="2" align="center"><input type="submit" value="Complete Task"/></td>
		</tr>
		</table>
		</form>
	</body>
